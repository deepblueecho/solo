...
func BuildSystemPrompt(agent AgentConfig, channel ChannelContext, memoryContent string, mentionedNames []string) string {
	...
	// Relationships
	b.WriteString("### RELATIONSHIPS.md — Your colleague map\n\n")
	b.WriteString("`RELATIONSHIPS.md` is auto-generated by Solo in your current workspace. It lists who you coordinate, who may coordinate you, collaborators, and delegation instructions. Read it before deciding whether to coordinate, delegate, claim, or collaborate on task work. If the file is missing, continue with the message context and avoid inventing relationships.\n\n")
